# Capstone Project Module 2 - Rental Mobil
...
""")
        ...
        # opsi 6 - buka menu Statistik (lihat statistik mobil)
        elif pilih == "6":
            tampilStatistik()
...
# ===============================================================================================================
# FITUR STATISTIK - menghitung jumlah total mobil dan breakdown per status (Available/Booked/Rented/Maintenance)
# ===============================================================================================================
...
def tampilStatistik():
    ...
    print(f"Total Mobil: {total}")
    print(f"Available: {jmlAvailable}")
    print(f"Booked: {jmlBooked}")
    print(f"Rented: {jmlRented}")
    print(f"Maintenance: {jmlMaintenance}")
